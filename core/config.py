...
JOB_HUNTER_SOURCES = [s.strip() for s in _jh_sources.split(",")] if _jh_sources else None
JOB_HUNTER_KEYWORDS = [k.strip() for k in _jh_keywords.split(",")] if _jh_keywords else None
