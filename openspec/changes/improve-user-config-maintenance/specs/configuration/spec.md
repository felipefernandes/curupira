...
## Purpose
The Configuration system governs how Curupira settings are defined, loaded, and maintained by the user. It prioritizes human readability while maintaining flexible environmental overrides for advanced deployments.
