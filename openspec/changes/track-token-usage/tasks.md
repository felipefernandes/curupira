...
1. [x] Atualizar o SQLite `core/memory.py`:
...
2. [x] Modificar `core/agent.py` para processar custos:
...
3. [x] Criar a Skill `get_usage_report`:
...
4. [x] Atualizar Instalação/Configuração:
